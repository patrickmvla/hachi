...
import { loginSchema, type LoginFormData } from "@/features/auth/schema/login";
...
function LoginForm() {
  ...
  const handleGitHubSignIn = async () => {
    ...
    try {
      ...
      setServerError("Failed to sign in with GitHub. Please try again.");
        ...
        <div className="relative w-full max-w-[420px] mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label htmlFor="password" className="text-[13px] font-medium text-black/70">
                    Password
                  </label>
                  <Link
          ...
          >
            <p className="text-center text-[13px] text-black/40">
              ...
              <Link href="/signup" className="text-black/70 hover:text-black underline underline-offset-4 transition-colors">
                Sign up
              </Link>
            </p>
